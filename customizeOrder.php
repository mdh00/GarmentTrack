...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO customizedProduct(productName,size,colorCode,fabricType,description,unitPrice,quentity,estimatedPayment)
                VALUES('$productName', '$size', '$colorCode', '$fabricType', '$description', '$unitPrice', '$quentity', '$estimatedPayment')";
...
<body>
    ...
    <div class="container">
        ...
        <div class="formContainer">
            ...
            <form method="post">
                <div class="formTopic">customize order</div>
                <div class="row">
                    <div class="columnOne">
                ...
                <div class="row">
                    ...
                    <div class="columnTwo">
                        <input type="text" name="color" required autocomplete="off" placeholder="Gray or #FF6347">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="columnTwo">
                        <textarea name="orderDescribe" cols="30" rows="5" required placeholder="Let us know your requirements by typing..."></textarea>
                ...
                <div class="row">
                    ...
                    <div class="columnTwo">
                        <input type="text" name="quentity" required autocomplete="off">
